! function (e) {
    ...
    e(document).ready((function () {
        ...
        e(document).on("click", ".js-add-to-wishlist-button", (function (t) {
            ...
            e.ajax({
                ...
                success: function (t) {
                    ...
                    if (a.find("i").hasClass("far fa-heart")) {
                        a.find("i").removeClass("far fa-heart").addClass("fa fa-heart");
                    }
        ...
        e(document).on("click", ".js-remove-from-wishlist-button", (function (t) {
            ...
            e.ajax({
                ...
                success: function (t) {
                    if (t.error) {
                        a.removeClass("button-loading");
                        window.showAlert("alert-danger", t.message), !1;
                        return false;
                    }
                    window.showAlert("alert-danger", t.message);
                    e(".wishlist-count span").text(t.data.count);
                    a.removeClass("button-loading");
                    a.toggleClass("wis_added");
                    if (a.find("i").hasClass("fa fa-heart")) {
                        a.find("i").removeClass("fa fa-heart").addClass("far fa-heart");
                    }
        ...
        e(document).on("change", ".form-review-product input[type=file]", (function (t) {
            ...
            t.preventDefault(), t.stopPropagation();
            var a = parseInt(e(this).closest(".detail-qty").find(".qty-val").val(), 10);
            (a -= 1) > 1 || (a = 1), e(this).closest(".detail-qty").find("input").val(a).trigger("change"), a >= 0 && e(this).closest(".section--shopping-cart").length && l(e(this))
