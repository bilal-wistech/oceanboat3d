...
app()->booted(function () {
    ...
    ThemeSupport::registerAboutVisionShortcode();
    ...
    add_shortcode('reviews-testimonials', __('Reviews & Testimonials'), __('Reviews & Testimonials'), function () {
        return Theme::partial('shortcodes.reviews-testimonials');
    });
