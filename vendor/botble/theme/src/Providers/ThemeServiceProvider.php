...
use Botble\Theme\Repositories\Eloquent\VideoBackgroundRepository;
...
use Botble\Theme\Repositories\Caches\VideoBackgroundCacheDecorator;
...
class ThemeServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(VideoBackgroundInterface::class, function () {
            return new VideoBackgroundCacheDecorator(new VideoBackgroundRepository(new VideoBackground()));
        });
    ...
    public function boot(): void
    {
        ...
        Event::listen(RouteMatched::class, function () {
            ...
            dashboard_menu()
                ...
                ->registerItem([
                    'id' => 'cms-core-video-background',
                    'priority' => 5,
                    'parent_id' => 'cms-core-appearance',
                    'name' => 'Video Background',
                    'icon' => null,
                    'url' => route('theme.video-background'),
                    'permissions' => ['theme.options'],
                ])
                ->registerItem([
