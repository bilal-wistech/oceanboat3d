...
<div class="shipping-management ">
    <label class="text-title-field"><b>DHL {{ trans('plugins/ecommerce::products.form.shipping.title') }} Information</b></label>
    <div class="row">
        <div class="col-md-3 col-md-6">
            <div class="form-group mb-3">
                <label>Gross weight of the shipment including packaging.</label>
                <div class="next-input--stylized">
        ...
        <div class="col-md-3 col-md-6">
            <div class="form-group mb-3">
                <label>Total length of the shipment including packaging.</label>
                <div class="next-input--stylized">
        ...
        <div class="col-md-3 col-md-6">
            <div class="form-group mb-3">
                <label>Total width of the shipment including packaging.</label>
                <div class="next-input--stylized">
                    <span class="next-input-add-on next-input__add-on--before">{{ ecommerce_width_height_unit() }}</span>
        ...
        <div class="col-md-3 col-md-6">
            <div class="form-group mb-3">
                <label>Total height of the shipment including packaging.</label>
                <div class="next-input--stylized">
                    <span class="next-input-add-on next-input__add-on--before">{{ ecommerce_width_height_unit() }}</span>
