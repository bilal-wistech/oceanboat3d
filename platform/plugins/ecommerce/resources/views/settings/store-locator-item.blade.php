...
<div class="next-form-section">
    ...
    <div class="next-form-grid">
        <div class="next-form-grid-cell">
            <label class="text-title-field">Postal Code</label>
            <input type="text" class="next-input" name="postal_code" placeholder="Postal Code" value="{{ $locator ? $locator->postal_code : null}}">
        </div>
        <!-- <div class="next-form-grid-cell">
