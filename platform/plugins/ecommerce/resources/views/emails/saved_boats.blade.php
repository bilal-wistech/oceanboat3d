                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="min-height: 400px; padding: 15px; font-size: 13px;">
                                                    ...
                                                    <p>We noticed you have booked a boat from our site, would you like
                                                        to continue?</p>

                                                    <a href="{{ url('customer/saved_boats') }}"
                                                        class="button button-blue">View Saved Boats</a> or <a
                                                        href="{{ url('/') }}">Go to our Site</a>
                                                    ...
                                                    <p>If you have any questions, please contact us via <a
                                                            href="mailto:info@oceanboats.ae">info@oceanboats.ae</a></p>
