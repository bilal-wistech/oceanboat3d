...
?>
    <div class="max-width-1200" id="main-order-content">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pl5 p-r5 text-end">
                                                    <div class="inline_block">
                                                        <span>{{ human_price_text_cart($orderProduct->price) }}</span>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="pl5 text-end">{{ human_price_text_cart($orderProduct->price * $orderProduct->qty) }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                                            ...
                                            <table class="table-normal table-none-border table-color-gray-text">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end pl10">
                                                        <span>{{ human_price_text_cart($order->sub_total) }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-end p-none-b pl10">
                                                        <p class="mb0">{{ human_price_text_cart($order->discount_amount) }}</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-end color-subtext mt10">
                                                        <p class="mb0">{{ trans('plugins/ecommerce::order.shipping_fee') }}</p>
                                                        <p class="mb0 font-size-12px">DHL Express</p>
                                                    </td>
                                                    <td class="text-end p-none-t pl10">
                                                        <p class="mb0">{{ human_price_text_cart($order->shipping_amount) }}</p>
                                                    </td>
                                                </tr>
                                                @if (EcommerceHelper::isTaxEnabled())
                                                    <tr>
                                                        ...
                                                        <td class="text-end p-none-t pl10">
                                                            <p class="mb0">{{ human_price_text_cart($order->tax_amount) }}</p>
                                                        </td>
                                                    </tr>
                                                @endif
                                                <tr>
                                                    ...
                                                    <td class="text-end text-no-bold p-none-t pl10">
                                                        @if ($order->payment->id)
                                                            <a href="{{ route('payment.show', $order->payment->id) }}"
                                                               target="_blank">
                                                                <span>{{ human_price_text_cart($order->amount) }}</span>
                                                            </a>
                                                        @else
                                                            <span>{{ human_price_text_cart($order->amount) }}</span>
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end color-subtext pl10">
                                                        @if ($order->payment->id)
                                                            <a href="{{ route('payment.show', $order->payment->id) }}"
                                                               target="_blank">
                                                                <span>{{ human_price_text_cart($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::COMPLETED ? $order->payment->amount : 0) }}</span>
                                                            </a>
                                                        @else
                                                            <span>{{ human_price_text_cart($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::COMPLETED ? $order->payment->amount : 0) }}</span>
                                                        @endif
                                                ...
                                                @if ($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::REFUNDED)
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="text-end pl10">
                                                            <span>{{ human_price_text_cart($order->payment->amount) }}</span>
                                                        </td>
                                                    </tr>
                                                @endif
                                                <tr class="hidden">
                                                    ...
                                                    <td class="text-end pl10">
                                                        <span>{{ human_price_text_cart($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::COMPLETED ? $order->amount : 0) }}</span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    @elseif ($order->payment->id)
                                        ...
                                        <div class="flexbox-auto-content ml15 mr15 text-upper">
                                            ...
                                            @elseif ($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::COMPLETED)
                                                <span>{{ trans('plugins/ecommerce::order.payment_was_accepted', ['money' => human_price_text_cart($order->payment->amount - $order->payment->refunded_amount)]) }}</span>
                                                                ...
                                                                <div class="timeline-dropdown"
                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ human_price_text_cart(Arr::get($history->extras, 'amount', 0)) }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <div class="timeline-dropdown"
                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ human_price_text_cart($order->payment->amount) }}</td>
                                                                        </tr>
                                                                        <tr>
        ...
        @if ($order->status != \Botble\Ecommerce\Enums\OrderStatusEnum::CANCELED)
            ...
            {!! Form::modalAction('confirm-refund-modal', trans('plugins/ecommerce::order.refund'), 'info', view('plugins/ecommerce::orders.refund.modal', ['order' => $order, 'url' => route('orders.refund', $order->id)])->render(), 'confirm-refund-payment-button', trans('plugins/ecommerce::order.refund') . ' <span class="refund-amount-text">' . human_price_text_cart($order->payment->amount - $order->payment->refunded_amount) . '</span>') !!}
