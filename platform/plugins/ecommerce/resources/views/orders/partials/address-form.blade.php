<div class="customer-address-payment-form">
    ...
    <div class="address-form-wrapper @if (auth('customer')->check() && $isAvailableAddress && (!empty($sessionAddressId) && $sessionAddressId !== 'new')) d-none @endif">
        ...
        <div class="row">
            ...
            <input type="text"  style="width:100%;" name="address[phone]" id="address_phone" placeholder="Phone Number" class="form-control address-control-item address-control-item-required checkout-input" value="{{ old('address.phone', Arr::get($sessionCheckoutData, 'phone')) }}">
                    {!! Form::error('address.phone', $errors) !!}
                </div>
            </div>
 ...
 <!-- comment end -->
            ...
            <div class="col-12">
                <div class="form-group mb-4 @if ($errors->has('address.postal_code')) has-error @endif">
                    <input id="address_postal_code" type="text" class="form-control address-control-item address-control-item-required checkout-input" placeholder="Postal Code" name="address[postal_code]" value="{{ old('address.postal_code', Arr::get($sessionCheckoutData, 'postal_code')) }}">
                    {!! Form::error('address.postal_code', $errors) !!}
                </div>
            </div>
