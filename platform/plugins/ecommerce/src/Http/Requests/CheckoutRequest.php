...
class CheckoutRequest extends Request
{
    public function rules(): array
    {
        ...
        if (EcommerceHelper::isAvailableShipping($products)) {
            ...
            $rules['shipping_amount'] = 'required_with:shipping_method|gt:0';
    ...
    public function messages(): array
    {
        return apply_filters(PROCESS_CHECKOUT_MESSAGES_REQUEST_ECOMMERCE, [
            ...
            'address.area.required' => 'District or Area is required',
            'address.address.required' => 'Street Name is required',
            'address.building.required' => 'Building or Villa No. is required',
    ...
    public function attributes(): array
    {
        return [
            ...
            'address.area' => __('area'),
            'address.address' => __('Address'),
            'address.building' => __('building'),
