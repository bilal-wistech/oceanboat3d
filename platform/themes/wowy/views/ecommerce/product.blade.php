        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="detail-info">
             <p class="title1 mb-15">Accessory</p>
                <h2 class="title-detail mb-10">{{ $product->name }}</h2>
...
<!-- 
                ...
                <ul class="rem-detail font-xs color-grey mt-50">
                    @if ($product->sku)
                        <li class="mb-5"><span class="d-inline-block" id="product-sku"><strong>{{ __('SKU') }}</span>:</strong>&nbsp;<span>{{ $product->sku }}</span></li>
                    @endif

                    @if ($product->categories->count())
                        <li class="mb-5"><span class="d-inline-block"><strontg>{{ __('Categories') }}:</strong>&nbsp;</span>
                    ...
                    @if ($product->tags->count())
                        <li class="mb-5"><span class="d-inline-block"><strong>{{ __('Tags') }}:</span></strong>&nbsp;
                    ...
                    <li><span class="d-inline-block"><strong>{{ __('Availability') }}:</span></strong>&nbsp;<span class="in-stock text-success ml-5">{!! BaseHelper::clean($product->stock_status_html) !!}</span></li>
                </ul>
            </div>
            <!-- Detail Info -->
