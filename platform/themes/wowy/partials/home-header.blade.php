...
<head>
    ...
    <link
        href="{{ $fontURL }}/css2?family={{ urlencode(theme_option('font_text', 'Poppins')) }}:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap"
        rel="stylesheet">
        ...
        <div class="video-banner" style="width: 100%; height:100vh; overflow:hidden">
            <div class="section hero">
                ...
                <div class="banner-text">
                    ...
                    <a href="{{ url('/' . $videoBackground->action) }}"><button type="button"
                            class="btn explore mt-40">{{ $videoBackground->action_title }}</button></a>
                </div>
            </div>
        </div>
    @else
        ...
        <div id="img-banner">
            <div class="img hero"
                style="position: relative; width: 100%; height: 100vh; overflow: hidden; background-image: url('{{ RvMedia::getImageUrl($parallelslider->image) }}'); background-size: cover; background-position: left; background-repeat: no-repeat;">
                <div class="banner-text" style="position: absolute; margin-top: 50px; margin-left: 30px; color: white;">
                    ...
                    <a href="{{ url('/' . $parallelslider->action) }}"><button type="button"
                            class="btn explore mt-40">{{ $parallelslider->action_title }}</button></a>
                </div>
            </div>
        </div>
    @endif
                ...
                <ul class="header-navbar-bottom-right header-navbar-bottom">
                    ...
                    @if (auth('customer')->check())
                        <li><a href="{{ route('customer.overview') }}"><img alt="{{ __('Sign In') }}"
                                    ...
                                    style="width: 16%;position: absolute;float: right;"></a></li>
                    @else
                        <li><a href="{{ route('customer.login') }}"><button type="button" class="btn login">Log
                                    In</button></li>
                    @endif
                </ul>
            </div>
